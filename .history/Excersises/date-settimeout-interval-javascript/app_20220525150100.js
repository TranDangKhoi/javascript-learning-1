...
function timeSince(date) {
    ...
    const newTime = (now.getTime() - yourDate.getTime()) / 1000;
    console.log(newTime);
    if (newTime / 60 > 60) {
        return `Online ${newTime.toFixed()} phút trước`;
    }
}

console.log(timeSince("Wed May 25 2022 14:30:11 GMT+0700 (Indochina Time)"));
